...
class IndexController_reference extends Controller
{
    ...
    public function dentalchecker(){
        return \File::get(public_path() . '/dentalchecker.html');
    ...
    public function idishumhome(){
        return view('idishum_pages.idishum');
    }
    ...
    public function idishum_author_bck(){
        ...
        if(Auth::check()){
            ...
            $user_id = Auth::user()->id;
            $articles = Article::where("author_id", $user_id)->first();

             return view('_particles.idishumauthor', compact('articles'));
        }
    ...
    public function push_created_article(Request $request){
        ...
        /**
         * If Ambulance has been delegated
         */

        // if(isset($inputs["ambulance"])){

            

        // }
        /**
         * End If Ambulance has been delegated
         */
        

        /**
         * If ambulance has not been delegated, push to DB and direct to delegation
         */
        $articles->save();
        ...
        return redirect("/idishum-create-article");   
