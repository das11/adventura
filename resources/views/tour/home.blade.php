			...
			<div class="container">
				<div class="row fullscreen d-flex align-items-center justify-content-center">
					<div class="banner_content">
						<p>Plan a trip to the World</p>
						<h2>Cipher Adventura</h2>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row align-items-end justify-content-left">
					<div class="col-lg-12">
						<div class="main_title">
							<p>We’re Offering these Popular Packages</p>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-feature">
							...
							<a href="/package?id={{$package->packageid}}" class="primary-btn mb-40">Read More</a>
							</div>
							<div class="feature-thumb">
								<img class="img-fluid" src="{{ URL::asset('site_assets/img/service/s1.png') }}" alt="">
							</div>
						</div>
					</div>
					@endforeach
				...
				<div class="row">
					<div class="col-lg-4 col-md-6">
						<div class="single-package">
							<div class="thumb">
								<img class="img-fluid" src="{{ URL::asset('site_assets/img/package/p1.jpg" ') }}alt="">								
							</div>
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-package">
							<div class="thumb">
								<img class="img-fluid" src="{{ URL::asset('site_assets/img/package/p2.jpg" ') }}alt="">								
							</div>
							<p class="date"><span>18</span> <br> December</p>
							<div class="meta-top d-flex">
								<p><span class="fa fa-location-arrow"></span> Stockholmes</p>
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-package">
							<div class="thumb">
								<img class="img-fluid" src="{{ URL::asset('site_assets/img/package/p3.jpg" ') }}alt="">								
							</div>
							<p class="date"><span>18</span> <br> December</p>
							<div class="meta-top d-flex">
								<p><span class="fa fa-location-arrow"></span> Stockholmes</p>
		...
		<div class="container">
			<div class="row">
				...
				<div class="offset-lg-1 col-lg-6">
					<img class="cta-img img-fluid" src="{{ URL::asset('site_assets/img/cta-img.png') }}" alt="">
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="row team_inner">
				<div class="col-lg-3 col-md-6">
					<div class="team_item">
						<div class="team_img">
							<img class="img-fluid w-100" src="{{ URL::asset('site_assets/img/team/team-1.jpg') }}" alt="">
							<div class="hover">
								<h4>Randy Weaver</h4>
				...
				<div class="col-lg-3 col-md-6">
					<div class="team_item">
						<div class="team_img">
							<img class="img-fluid w-100" src="{{ URL::asset('site_assets/img/team/team-2.jpg') }}" alt="">
							<div class="hover">
								<h4>Randy Weaver</h4>
								<p>Senior Barrister at law</p>
							</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="team_item">
						<div class="team_img">
							<img class="img-fluid w-100" src="{{ URL::asset('site_assets/img/team/team-3.jpg') }}" alt="">
							<div class="hover">
								<h4>Randy Weaver</h4>
								<p>Senior Barrister at law</p>
							</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="team_item">
						<div class="team_img">
							<img class="img-fluid w-100" src="{{ URL::asset('site_assets/img/team/team-4.jpg') }}" alt="">
							<div class="hover">
								<h4>Randy Weaver</h4>
								<p>Senior Barrister at law</p>
							</div>
	...
	<div class="cta-area2 section_gap">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-5">
					<img class="cta-img2 img-fluid" src="{{ URL::asset('site_assets/img/cta-img2.png') }}" alt="">
				</div>
		...
		<div class="container">
			<div class="testi-slider owl-carousel" data-slider-id="1">
				<div class="item">
					<div class="testi-item">
						<img src="{{ URL::asset('site_assets/img/quote.png') }}" alt="">
						<h4>Fanny Spencer</h4>
						<ul class="list">
			...
			<div class="owl-thumbs d-flex justify-content-center" data-slider-id="1">
				<div class="owl-thumb-item">
					<div>
						<img class="img-fluid rounded-circle" src="{{ URL::asset('site_assets/img/testimonial/t1.jpg') }}" alt="">
					</div>
					<div class="overlay overlay-grad "></div>
				</div>
				<div class="owl-thumb-item">
					<div>
						<img class="img-fluid rounded-circle" src="{{ URL::asset('site_assets/img/testimonial/t2.jpg') }}" alt="">
					</div>
					<div class="overlay overlay-grad"></div>
				</div>
				<div class="owl-thumb-item">
					<div>
						<img class="img-fluid rounded-circle" src="{{ URL::asset('site_assets/img/testimonial/t3.jpg') }}" alt="">
					</div>
					<div class="overlay overlay-grad"></div>
				</div>
				<div class="owl-thumb-item">
					<div>
						<img class="img-fluid rounded-circle" src="{{ URL::asset('site_assets/img/testimonial/t4.jpg') }}" alt="">
					</div>
					<div class="overlay overlay-grad"></div>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="single-blog">
						<div class="blog-thumb">
							<img class="img-fluid" src="{{ URL::asset('site_assets/img/blog/h-blog1.jpg') }}" alt="">
						</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="single-blog">
						<div class="blog-thumb">
							<img class="img-fluid" src="{{ URL::asset('site_assets/img/blog/h-blog2.jpg') }}" alt="">
						</div>
						<div class="blog-details">
							<div class="blog-meta d-flex">
								<p>
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="single-blog">
						<div class="blog-thumb">
							<img class="img-fluid" src="{{ URL::asset('site_assets/img/blog/h-blog3.jpg') }}" alt="">
						</div>
						<div class="blog-details">
							<div class="blog-meta d-flex">
								<p>
