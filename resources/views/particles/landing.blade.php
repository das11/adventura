          ...
          <div class="col-lg-6 offset-lg-1">
            <div class="banner_text">
              <div class="banner_text_iner">
                <h1>Learn Grow Earn</h1>
                <h5>We create best opppurtunities</h5>
          ...
          <div class="col-sm-6 col-xl-4">
            <div class="single_feature">
              <div class="single_service">
                ...
                <p>
                 <i class="fa fa-mars-stroke-h" aria-hidden="true"></i> Academia for new research papers, projects guidance.
				  <br><br>
				<i class="fa fa-mars-stroke-h" aria-hidden="true"></i>  Students for project implementations, surveys, hiring interns and future employees.
				  <br><br>
				<i class="fa fa-mars-stroke-h" aria-hidden="true"></i>  Freelancers for project implementation, surveys etc.
          ...
          <div class="col-sm-6 col-xl-4">
            <div class="single_feature">
              <div class="single_service">
                ...
                <p>
                 <i class="fa fa-mars-stroke-h" aria-hidden="true"></i> Industry for technology transfer, project guidance, industrial knowhow.
				  <br><br>
				 <i class="fa fa-mars-stroke-h" aria-hidden="true"></i> Students for teaching, training and guiding them.
                </p>
                <br>
          ...
          <div class="col-sm-6 col-xl-4">
            <div class="single_feature">
              <div class="single_service">
                ...
                <p>
                 <i class="fa fa-mars-stroke-h" aria-hidden="true"></i> Industry for industrial knowhow, projects, internships, jobs.
				  <br><br>
				 <i class="fa fa-mars-stroke-h" aria-hidden="true"></i> Academia for education, training, guidance.
                </p>
                <br>
